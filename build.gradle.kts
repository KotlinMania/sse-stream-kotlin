...
kotlin {
    ...
    val xcf = XCFramework("SseStream")

    macosArm64 {
        binaries.framework { baseName = "SseStream"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SseStream"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "SseStream"
        flattenPackage = "io.github.kotlinmania.ssestream"
    }

    android {
        namespace = "io.github.kotlinmania.ssestream"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "sse-stream-kotlin", version.toString())

    pom {
        name.set("sse-stream-kotlin")
        description.set("Kotlin Multiplatform port of 4t145/sse-stream - Conversion between http body and sse stream")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/sse-stream-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/sse-stream-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/sse-stream-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/sse-stream-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSseStreamXCFramework",
    "assembleSseStreamDebugXCFramework",
    "assembleSseStreamReleaseXCFramework",
    "assembleDebugIosFatFrameworkForSseStreamXCFramework",
    "assembleReleaseIosFatFrameworkForSseStreamXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForSseStreamXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForSseStreamXCFramework",
    "assembleDebugMacosFatFrameworkForSseStreamXCFramework",
    "assembleReleaseMacosFatFrameworkForSseStreamXCFramework",
    "assembleDebugTvosFatFrameworkForSseStreamXCFramework",
    "assembleReleaseTvosFatFrameworkForSseStreamXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForSseStreamXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForSseStreamXCFramework",
    "assembleDebugWatchosFatFrameworkForSseStreamXCFramework",
    "assembleReleaseWatchosFatFrameworkForSseStreamXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForSseStreamXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForSseStreamXCFramework",
