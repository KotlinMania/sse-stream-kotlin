...
This file is the quick-reference operating contract for sse-stream-kotlin. The longer
...
sse-stream-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`sse-stream`](https://crates.io/crates/sse-stream). Upstream Rust is the behavioral oracle while the
